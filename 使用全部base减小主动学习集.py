...
res2 = pd.read_csv('./B/base_des161_456_cross_98.2.csv',header=None, index_col=None)
res3 = pd.read_csv('./B/base_des169_123_cross_97.7.csv',header=None, index_col=None)
res4 = pd.read_csv('./B/base_res152_456_cross_97.3.csv',header=None, index_col=None)
res5 = pd.read_csv('./B/base_res101_456_cross_97.9.csv',header=None, index_col=None)

res6 = pd.read_csv('./B/base_res101_456_ohem0.7_97.5.csv',header=None, index_col=None)
...
for j in range(1000):
    if (
        final['1label'][j]==
        final['2label'][j]==final['3label'][j]
        ==final['4label'][j]==final['5label'][j]
...
result= final[[0,1]]
result.to_csv('./B/6_learn.csv',index=False,header=False)

sampel_train = list(zip(pic_name_list,label_list))
pretrain = pd.DataFrame(data = sampel_train)  
pretrain.to_csv('./vote/6_pre_testb.csv')     
print(n)
