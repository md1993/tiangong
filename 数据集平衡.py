...
if __name__ == '__main__':
    ...
    global file_name
    file_name = 'resnet152_456_cross_leran'
    # 创建保存模型和结果的文件夹
    ...
    testb_csv = pd.read_csv('/content/drive/My Drive/tiangong/pre_testb.csv',header = None,encoding='utf-8')
    ...
    oversampler = SMOTE ( random_state = randseed )
